...
export default function ComplianceExportPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const result = await generateExportBundle(config);
      setLastExport({
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground text-sm">
          Generate de-identified data bundles for regulatory compliance
        </p>
      </div>
              ...
              >
                ...
                >
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-muted-foreground text-sm">
                      De-identified data from all organizations
                    </p>
                  </div>
                </Label>
                <Label
                  htmlFor="scope-org"
                  className="flex cursor-pointer items-start gap-3 rounded-lg border p-4 hover:bg-accent [&:has([data-state=checked])]:border-primary opacity-50 cursor-not-allowed"
                >
                  <RadioGroupItem value="organization" id="scope-org" disabled />
                  <div className="space-y-1">
                    <p className="font-medium">Single Organization</p>
                    <p className="text-muted-foreground text-sm">
                      Data from a specific organization (coming soon)
                    </p>
                  </div>
                </Label>
              </RadioGroup>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between rounded-lg border p-4">
                <div className="space-y-0.5">
                  ...
                  <p className="text-muted-foreground text-sm">
                    De-identified supervision decisions and system events
                  </p>
                </div>
                <input
                  type="checkbox"
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="font-medium">
                    {config.scope === 'global' ? 'All Organizations' : 'Single Org'}
                  </span>
                </div>
                <div className="flex items-center gap-2 text-sm">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-amber-600 dark:text-amber-400 text-xs mt-1">
                    All exports use pseudonymous subject IDs. No direct patient identifiers are
                    included.
                  </p>
                </div>
              </div>
